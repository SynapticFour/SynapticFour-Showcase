# Kenya evaluation fixture (Showcase CI)

**Status:** EVALUATION-ONLY
**Not:** ODPC certification, PRODUCTION profile, patient system-of-record, or “Kenya-compliant” marketing.

| Field | Value |
|-------|--------|
| Solum profile id | `kenya-dpa` |
| Profile path (Solum repo) | `config/profiles/kenya-dpa.toml` |
| Jurisdiction | `KE` |
