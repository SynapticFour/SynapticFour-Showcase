...
| **1b. H2 spine v1** | [pilots/H2-PILOT-CHECKLIST.md](pilots/H2-PILOT-CHECKLIST.md) · [H2-EXECUTION-RECORD.md](pilots/H2-EXECUTION-RECORD.md) · [H2-OPS-RUNBOOK.md](pilots/H2-OPS-RUNBOOK.md) | **SIGNED OFF** spine v1 (WES 401, visas honesty, zeroize, ops); full cross-plane consent still open |
...
**Immediate execution order:** send Kenya K1 brief to counsel; timebox EHRbase compose spike; remaining H2 (consent↔Ferrum, Solum KMS CLI, OIDC→Solum CAP) as product backlog.
